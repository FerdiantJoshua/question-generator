...
#================================================== TRANSLATE ==================================================
onmt_translate -model 'models/checkpoints/onmt/transformer_005_step_101920.pt' \
    -src '/raid/ayu/ferdiant/data/processed/test/squad_id_cased_source.txt' -output 'reports/txts/onmt/transformer_005_step_101920_pred.txt' -replace_unk \
    -beam_size 5 \
    -max_length 20
...
python src/onmt/run_evaluation.py \
    ...
    --prediction_file='reports/txts/onmt/transformer_005_step_101920_pred.txt' \
    --log_file='reports/txts/onmt/eval_log_transformer_005_step_101920.txt'