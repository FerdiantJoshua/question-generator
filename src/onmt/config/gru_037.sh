...
#================================================== TRAIN ==================================================
onmt_train -data 'data/processed/onmt/squad_id_split0.9_uncased' -save_model 'models/checkpoints/onmt/gru_037' \
...
#================================================== TRANSLATE ==================================================
#-------------------------------------------------- SQUAD --------------------------------------------------
onmt_translate -model 'models/checkpoints/onmt/gru_037_step_32100.pt' \
    -src 'data/processed/test/squad_id_split0.9_uncased_source.txt' -output 'reports/txts/onmt/gru_037_step_32100_pred.txt' -replace_unk \
    -seed 42 \
    -beam_size 5 \
    -max_length 20
...
#-------------------------------------------------- TYDIQA --------------------------------------------------
onmt_translate -model 'models/checkpoints/onmt/gru_037_step_32100.pt' \
    -src 'data/processed/test/tydiqa_id_split0.9_uncased_source.txt' -output 'reports/txts/onmt/gru_037_step_32100_pred_tydiqa.txt' -replace_unk \
    -seed 42 \
    -beam_size 5 \
    -max_length 20
...
python src/onmt/run_evaluation.py \
    ...
    --prediction_file='reports/txts/onmt/gru_037_step_32100_pred.txt' \
    --log_file='reports/txts/onmt/eval_log_gru_037_step_32100.txt'
...
python src/onmt/run_evaluation.py \
    ...
    --prediction_file='reports/txts/onmt/gru_037_step_32100_pred_tydiqa.txt' \
    --log_file='reports/txts/onmt/eval_log_gru_037_step_32100_tydiqa.txt'
