...
#================================================== TRAIN ==================================================
onmt_train -data 'data/processed/onmt/squad_id_split0.9_cased' -save_model 'models/checkpoints/onmt/transformer_008' \
    ...
    -batch_size 256 -accum_count 2 \
    -optim adam -adam_beta2 0.998 -decay_method noam -warmup_steps 4020 -learning_rate 1 \
    -max_grad_norm 1 \
    -valid_steps 4020 -save_checkpoint_steps 4020

#================================================== TRANSLATE ==================================================
onmt_translate -model 'models/checkpoints/onmt/transformer_008_step_80400.pt' \
    -src 'data/processed/test/squad_id_split0.9_cased_source.txt' -output 'reports/txts/onmt/transformer_008_step_80400_pred.txt' -replace_unk \
    -seed 42 \
    -beam_size 5 \
    -max_length 20
...
python src/onmt/run_evaluation.py \
    ...
    --prediction_file='reports/txts/onmt/transformer_008_step_80400_pred.txt' \
    --log_file='reports/txts/onmt/eval_log_transformer_008_step_80400.txt'