...
#================================================== TRAIN ==================================================
onmt_train -data 'data/processed/onmt/squad_id_split0.9_cased' -save_model 'models/checkpoints/onmt/transformer_010' \
    ...
    -feat_merge mlp \
    -keep_checkpoint 4 \
    -layers 4 -rnn_size 300 -word_vec_size 300 -transformer_ff 512 -heads 4 \
...
#================================================== TRANSLATE ==================================================
onmt_translate -model 'models/checkpoints/onmt/transformer_010_step_80400.pt' \
    -src 'data/processed/test/squad_id_split0.9_cased_source.txt' -output 'reports/txts/onmt/transformer_010_step_80400_pred.txt' -replace_unk \
    -seed 42 \
    -beam_size 5 \
    -max_length 20
...
python src/onmt/run_evaluation.py \
    ...
    --prediction_file='reports/txts/onmt/transformer_010_step_80400_pred.txt' \
    --log_file='reports/txts/onmt/eval_log_transformer_010_step_80400.txt'