...
#================================================== TRAIN ==================================================
onmt_train -data 'data/processed/onmt/squad_id_split0.9_uncased' -save_model 'models/checkpoints/onmt/lstm_036' \
    -world_size 1 -gpu_ranks 0 \
    -seed 42 \
    -save_checkpoint_steps 8025 \
    -word_vec_size 300 \
    -train_from 'models/checkpoints/onmt/lstm_036_step_16050.pt'\
