...
#================================================== TRAIN ==================================================
onmt_train -data '/raid/ayu/ferdiant/data/processed/onmt/squad_id_cased' -save_model 'models/checkpoints/onmt/lstm_016' \
    -world_size 1 -gpu_ranks 0 \
    -save_checkpoint_steps 7195 \
    -word_vec_size 300 \
    -train_from 'models/checkpoints/onmt/lstm_016_step_21585.pt' \
...
#================================================== TRANSLATE ==================================================
onmt_translate -model 'models/checkpoints/onmt/lstm_016_step_28780.pt' \
    -src '/raid/ayu/ferdiant/data/processed/test/squad_id_cased_source.txt' -output 'reports/txts/onmt/lstm_016_step_28780_pred.txt' -replace_unk \
    -beam_size 5 \
    -max_length 20 \
    -verbose
...
python src/onmt/run_evaluation.py \
    ...
    --prediction_file='reports/txts/onmt/lstm_016_step_28780_pred.txt' \
    --log_file='reports/txts/onmt/eval_log_lstm_016_step_28780.txt'