#================================================== PREPROCESS ==================================================
onmt_preprocess -train_src 'data/train/squad_id_cased_source.txt' -'train_tgt data/train/squad_id_cased_target.txt' \
    -valid_src 'data/val/squad_id_cased_source.txt' -valid_tgt 'data/val/squad_id_cased_target.txt' \
    -dynamic_dict \
...
#================================================== EMBEDDING ==================================================
./tools/embeddings_to_torch.py -emb_file_both 'models/word-embedding/ft_to_gl_300_id.vec' \
    -dict_file '../data/onmt/squad_id_cased.vocab.pt' \
    -output_file '../data/onmt/embeddings_cased'

#================================================== TRAIN ==================================================
#-------------------------------------------------- RNN --------------------------------------------------
!onmt_train -data 'data/onmt/squad_id_cased' -save_model 'models/checkpoints/onmt/lstm_001' \
    ...
    -dropout 0.3
#-------------------------------------------------- TRANSFORMER --------------------------------------------------
!onmt_train -data 'data/onmt/squad_id_cased' -save_model 'output/transformer_001' \
    -world_size 1 -gpu_ranks 0 \
    -train_from 'models/checkpoints/onmt/lstm_001_step_35975.pt' \
    -pre_word_vecs_enc 'data/onmt/embeddings_cased.enc.pt' \
    -pre_word_vecs_dec 'data/onmt/embeddings_cased.dec.pt' \
    -fix_word_vecs_enc \
    -fix_word_vecs_dec \
